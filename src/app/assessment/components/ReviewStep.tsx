...
const ReviewSection = ({ title, step, setStep, children }: any) => (
  <div style={{
...
export function ReviewStep({ setStep }: { setStep: (step: number) => void }) {
  ...
  return (
    <>
      ...
      <ReviewSection title="Profile Information" step={1} setStep={setStep}>
      ...
      <ReviewSection title="Business Details" step={2} setStep={setStep}>
      ...
      <ReviewSection title="Funding Request" step={3} setStep={setStep}>
      ...
      <ReviewSection title="Location" step={4} setStep={setStep}>
